...
(facts "About search"
  (fact "transforms Cloudant search"
    (search/search ..auth.. ..db.. ..rt.. ..q..) => {:search_results [..result1.. ..result2..]
                                                     :meta           {:bookmark   ..bookmark..
                                                                      :total_rows ..total..}}
    (provided
      (search/get-results ..auth.. ..db.. ..rt.. ..org.. [{:id     ..id1..
                                                           :order  [3.9 107]
                                                           :fields {:id   ..id1..
                                                                    :type k/PROJECT-TYPE}}
                                                          {:id     ..id2..
  ...
  (fact "Extracts entity ids"
    (let [rows [{:id     ..id1..
      ...
      (search/get-results ..auth.. ..db.. ..rt.. ..org.. rows) => [{:id            ..eid..
      ...
      (provided
        ...
        (core/get-entities ..auth.. ..db.. ..org.. [..eid.. ..fileprojectid..] ..rt..) => [{:_id        ..fileprojectid..
                                                                                            :type       k/PROJECT-TYPE
                                                                                            :owner      ..user2..
                                                                                           ...
                                                                                           {:_id        ..eid..
                                                                                            ...
                                                                                            :attributes {:name       ..project..
                                                                                                         :updated-at ..update1..}}]
        (core/get-entities ..auth.. ..db.. ..org.. [..eid.. ..id1..] ..rt..) => [{:_id        ..eid..
                                                                                  :type       k/PROJECT-TYPE
                                                                                  :owner      ..user1..
                                                                                  :attributes {:name       ..project..
                                                                                               :updated-at ..update1..}}
