...
(facts "About parents"
  (facts "all entities"
    (fact "is parents"
      (b/get-parents ..auth.. ..db.. ..org.. ..id.. ..rt..) => ..parents..
      (provided
        (links/get-link-targets ..auth.. ..db.. ..org.. ..id.. "parents" ..rt..) => ..parents..))))

(facts "About breadcrumbs"
  (against-background [(b/get-parents ..auth.. ..db.. ..org.. ..file1.. ..rt..) => [{:_id ..folder1..} {:_id ..folder2..}]
                       (b/get-parents ..auth.. ..db.. ..org.. ..file2.. ..rt..) => [{:_id ..folder2..}]
                       (b/get-parents ..auth.. ..db.. ..org.. ..folder1.. ..rt..) => [{:_id ..project1..}]
                       (b/get-parents ..auth.. ..db.. ..org.. ..folder2.. ..rt..) => [{:_id ..project1..} {:_id ..project2..}]
                       (b/get-parents ..auth.. ..db.. ..org.. ..project1.. ..rt..) => []
                       (b/get-parents ..auth.. ..db.. ..org.. ..project2.. ..rt..) => []
                       (core/get-entities ..auth.. ..db.. ..org.. #{..file1.. ..folder1.. ..folder2.. ..file2.. ..project1.. ..project2..} ..rt..) => [{:_id        ..file1..
                                                                                                                                                        :type       k/FILE-TYPE
    ...
    (fact "calculates file breadcrumbs"
      (b/get-breadcrumbs ..auth.. ..db.. ..rt.. ..org.. [..file1.. ..file2..]) => {..file1.. [[{:type k/FILE-TYPE :id ..file1.. :name ..filename1..}
