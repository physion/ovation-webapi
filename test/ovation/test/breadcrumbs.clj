...
(facts "About parents"
  (facts "all entities"
    (fact "is parents"
      (b/get-parents ..auth.. ..db.. ..id.. ..rt..) => ..parents..
      (provided
        (links/get-link-targets ..auth.. ..db.. ..id.. "parents" ..rt..) => ..parents..))))

(facts "About breadcrumbs"
  (against-background [(b/get-parents ..auth.. ..db.. ..file1.. ..rt..) => [{:_id ..folder1..} {:_id ..folder2..}]
                       (b/get-parents ..auth.. ..db.. ..file2.. ..rt..) => [{:_id ..folder2..}]
                       ...
                       (core/get-entities ..auth.. ..db.. #{..file1.. ..folder1.. ..folder2.. ..file2.. ..project1.. ..project2..} ..rt..) => [{:_id        ..file1..
                                                                                                                                                :type       k/FILE-TYPE
    ...
    (fact "calculates file breadcrumbs"
      (b/get-breadcrumbs ..auth.. ..db.. ..rt.. [..file1.. ..file2..]) => {..file1.. [[{:type k/FILE-TYPE :id ..file1.. :name ..filename1..}
